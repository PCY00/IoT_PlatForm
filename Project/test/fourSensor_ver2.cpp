/*
해당 코드는 완벽하지 않다. -> 30초정도는 생각한데로 돌아가는데 이후 읽는 값이 씹히는 경우 발생
...
void measureTemperatureAndHumidity();                                           //Temperature and humidity measurement
void controlRelayAndFan();                                                      //Relay and fan control
